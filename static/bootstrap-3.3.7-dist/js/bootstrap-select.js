    ...
    createDropdown: function () {
      ...
      drop =
        '<div class="dropdown bootstrap-select' + showTick + '">' +
          '<button type="button" class="' + this.options.styleBase + ' dropdown-toggle" ' + (this.options.display === 'static' ? 'data-display="static_inside"' : '') + 'data-toggle="dropdown"' + autofocus + ' role="button">' +
